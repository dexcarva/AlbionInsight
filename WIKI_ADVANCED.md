...
| :--- | :--- | :--- |
| **`albion_insight/core/`** | Contém a lógica central do aplicativo. É aqui que a decodificação do protocolo Photon e o gerenciamento de dados em tempo real ocorrem. | Python, Scapy, Protocolo Photon (Engenharia Reversa) |
