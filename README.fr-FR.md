...
[![Plateforme](https://img.shields.io/badge/platform-Linux%20%7C%20Windows%20%7C%20macOS-lightgrey.svg)](https://github.com/dexcarva/AlbionInsight)
[![Issues GitHub](https://img.shields.io/github/issues/dexcarva/AlbionInsight)](https://github.com/dexcarva/AlbionInsight/issues)
...
| `README.pt-BR.md` | Ce fichier de documentation en Portugais du Brésil. |
| `README.fr-FR.md` | Ce fichier de documentation en Français. |
| `CONTRIBUTING.md` | Directives pour la contribution au projet. |
| `CODE_OF_CONDUCT.md` | Le Code de Conduite du projet. |
| `SECURITY.md` | Politique pour signaler les vulnérabilités de sécurité. |
